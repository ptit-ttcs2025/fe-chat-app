    ...
    <>
      ...
      >
        ...
        <div className="chat-content" style={{ 
          ...
          {!isOwnMessage && (
            <div className="chat-profile-name" style={{ 
              marginBottom: '4px',
              lineHeight: 1.2,
              paddingLeft: '2px',
            }}>
          ...
          <div className="chat-info" style={{ position: 'relative', width: '100%' }}>
              ...
              <div className="dropup">
                ...
                >
                  <li>
                    ...
                    >
                      <i 
                        className={`ti ti-pin${message.pinned ? "-filled" : ""}`} 
                        style={{ 
                          fontSize: '16px', 
                          color: message.pinned ? '#667eea' : '#6b7280',
                        }} 
                      />
                      <span>{message.pinned ? "Bỏ ghim" : "Ghim tin nhắn"}</span>
                    </button>
                  </li>
                  {isOwnMessage && (
                    <li>
